...
NSString *docPath() {
    ...
    return [[pathList objectAtIndex:0] stringByAppendingPathComponent:@"data.id"];
}
...
#pragma mark - Table View managemet
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if ([tasks count] == 0) {
        ...
        [tasks addObject:@"Play the game"];
        [tasks addObject:@"Learn a code"];
    }
